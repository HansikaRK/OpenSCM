...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<SignUpResponse>> signUp(@Valid @RequestBody SignUpRequest signUpRequest) {
        log.info("Received signup request for customer: {}", signUpRequest.getUsername());

        SignUpResponse response = authService.registerUser(signUpRequest);
        ApiResponse<SignUpResponse> apiResponse = ApiResponse.success("Customer registered successfully", response);
